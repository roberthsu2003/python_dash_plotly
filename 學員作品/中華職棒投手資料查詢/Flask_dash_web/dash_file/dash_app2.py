...
dash2 = Dash(requests_pathname_prefix="/dash/rakuten/", external_stylesheets=[dbc.themes.BOOTSTRAP])
...
dash2.layout = html.Div(
    [
        dbc.Container([
            html.Div([
                html.Div([
                    html.Img(src=[cpbl_datasource.img_pic('rakuten_index')],width=1200),
                    html.Br(),
