...
app.layout = dbc.Container(children=[
    ...
    dbc.Row([
        dbc.Col(html.Div(children=[
                          dbc.Row(children=[
                             html.P("LoGo和name",className="col-6"),
                             html.P("Rank:1",className="col-6")
                            ]),
                          dbc.Row(children=[
                             html.P("63,997.00",className="col-6"),
                             html.P("$63997",className="col-6"),
                          ]),
                          dbc.Row(children=[
                             html.P("上漲:123",className="col-4",style={"fontSize":"8px"}),
                             html.P("cap:$1,207,899,559,001",className="col-8",style={"fontSize":"8px"}),
                          ])
                         ],
                         className="border"
                         )
                ),
        dbc.Col(html.Div("num2",className="border")),
        dbc.Col(html.Div("num3",className="border")),
        dbc.Col(html.Div("num4",className="border")),
    ],className="gx-3")
])
